layui.define(['layer'], function (exports) {
    ...
    var obj = {
        ...
        //自定义块
        layerDelblock: function (title, text, url, type, dataType, data, callback) {
            layer.confirm(text, {
                title: title,
                btnAlign: 'c',
                resize: false,
        ...
        //管理日志
        layerDellog: function (title, text, url, type, dataType, data, callback) {
            layer.confirm(text, {
                title: title,
                btnAlign: 'c',
                resize: false,
		            ...
		            $.ajax({
		                ...
		                success: function (data, startic) {
		                    if (data.code == 1) {
		                    	layer.msg('已删除!',{icon:1,time:1000});
		                    	setTimeout(function(){
//		                    		window.location.href = '/index.php/admin/log/index';
		                    		location.reload()
		                    	},1000)	
		                    }
		                    else {
        ...
        //内容管理
        layerDelcon: function (title, text, url, type, dataType, data, callback) {
            layer.confirm(text, {
                title: title,
                btnAlign: 'c',
                resize: false,
...
//		                    		window.location.href='/index.php/admin/content/index';
